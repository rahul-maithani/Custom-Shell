...
class Ui_MainWindow(object):
    def show_loading(self):
        ...
        self.loading_dialog.setWindowFlags(QtCore.Qt.FramelessWindowHint | QtCore.Qt.Popup)
        ...
        self.loading_dialog.move(self.centralwidget.mapToGlobal(
            QtCore.QPoint(center.x() - dlg_size.width() // 2,
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowFlags(QtCore.Qt.Window | QtCore.Qt.CustomizeWindowHint |
                                  QtCore.Qt.WindowTitleHint | QtCore.Qt.WindowCloseButtonHint)

        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(20, 0, 1061, 791))
        self.label.setMovie(QtGui.QMovie("animated2.gif"))
        ...
        self.pushButton = make_button(230, "#670D2F", "#A53860", "File Management", "FILE.jpeg", (40, 40))
        self.pushButton_2 = make_button(330, "#344C64", "#57A6A1", "Network", "network.png", (60, 60))
        self.pushButton_3 = make_button(430, "#1D267D", "#5C469C", "System Info", "SINFO.jpeg", (40, 40))
