...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Network Commands "))
        self.pushButton.setText(_translate("MainWindow", "Ping"))
        self.pushButton_2.setText(_translate("MainWindow", "Tracert"))
        self.pushButton_3.setText(_translate("MainWindow", "Host Name"))
        self.pushButton_4.setText(_translate("MainWindow", "IP Config"))
        self.pushButton_5.setText(_translate("MainWindow", "Curl"))
        self.pushButton_6.setText(_translate("MainWindow", "Get IP"))
